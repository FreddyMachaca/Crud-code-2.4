...
namespace Teletubbies_code_2._4
{
    public partial class Cliente : UserControl
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string consulta = "delete from cliente where id_cliente=" + textBox1.Text + "";
            SqlCommand comando = new SqlCommand(consulta, conexion);
            comando.ExecuteNonQuery();
        ...
        {
            conexion.Open();
            string consulta = "update cliente set id_cliente=" + textBox1.Text + ",nombre_Apellido='" + textBox2.Text + "',Ci='" + textBox3.Text + "',direccion='" + textBox4.Text + "'where id_cliente=" + textBox1.Text + "";
            SqlCommand comando = new SqlCommand(consulta, conexion);
            int cant;
